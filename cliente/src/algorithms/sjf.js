...
// Este algoritmo ejecuta primero los procesos con menor tiempo de ráfaga
export const sjf = (arrivalTime, burstTime) => {
  ...
  const readyQueue = []; // Cola de procesos listos
  const finishedJobs = []; // Procesos terminados
  ...
  for (let i = 0; i < processesInfo.length; i++) {
    ...
    // Ordenamos la cola por tiempo de ráfaga
